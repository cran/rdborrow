...
vignette: >
  %\VignetteIndexEntry{Simulation Workflow for OLE Phase}
...
difference-in-differences (DID) estimators proposed in
[Zhou et al. (2024)](https://doi.org/10.1080/10543406.2024.2330209)
for the open-label extension (OLE) phase.

The simulated data has four outcome columns (`y1`, `y2`, `y3`, `y4`)
and a crossover point `T_cross = 2`. This means:
